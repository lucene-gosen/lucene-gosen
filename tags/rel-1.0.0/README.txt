Installation With Apache Solr 3.1:
...
4. add "text_ja" fieldtype: see example/schema.xml.snippet for example configuration.
...
Installation with Apache Lucene 3.1:

1. run 'ant'. this will make lucene-gosen-{version}.jar
2. add this jar file to your classpath, and use JapaneseAnalyzer, or make your own analyzer from
